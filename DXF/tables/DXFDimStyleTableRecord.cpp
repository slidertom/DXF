...
CDXFDimStyleTableRecord &CDXFDimStyleTableRecord::operator=(const CDXFDimStyleTableRecord &record)
{
    ...
    m_ulDimLdrBlkHandle = record.m_ulDimLdrBlkHandle;
    m_ulDimBlkHandle = record.m_ulDimBlkHandle;
    m_ulDimBlk1Handle = record.m_ulDimBlk1Handle;
    m_ulDimBlk2Handle = record.m_ulDimBlk2Handle;
...
const CDXFObjectID &CDXFDimStyleTableRecord::GetDimBlk0(const CDXFDatabase *pDB)
{
...
const CDXFObjectID &CDXFDimStyleTableRecord::GetDimBlk1(const CDXFDatabase *pDB)
{
...
const CDXFObjectID &CDXFDimStyleTableRecord::GetDimBlk2(const CDXFDatabase *pDB)
{
