...
CDXFAlignedDimension *CDXFAlignedDimension::CreateDimension(double x1, double y1, double x2, double y2, double dHeight, bool bNoDimLines,
                                                            ...
                                                            CDXFBlockTableRecord *pBlock, CDXFDatabase *pDB)
{
    ...
    pBlock->AddEntity(pDimension, pDB);
    CDXFAlignedDimension::Init(pDimension, pDB);
    return pDimension;
}